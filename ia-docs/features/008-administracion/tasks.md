...
- [x] Verificación manual con el backend real (listado, crear con restricciones de rol, editar rol, desactivar/activar, acceso agente denegado). *(pendiente: requiere `pnpm dev` + backend FastAPI)*
