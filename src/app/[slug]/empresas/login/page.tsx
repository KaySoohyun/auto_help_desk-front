...
export default async function EmpresasLoginPage({ params }: Props) {
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4 py-12">
      <div className="w-full max-w-md space-y-8">
        <div className="space-y-2 text-center">
          ...
          <h1 className="text-2xl font-bold tracking-tight">Portal Empresas · {tenant.name}</h1>
          ...
          <CardContent className="space-y-6">
            <Tabs defaultValue="login" className="w-full">
              ...
              <TabsContent value="register" className="mt-4">
                <RegisterForm role="agent" tenant={tenant} />
              </TabsContent>
            </Tabs>

            <Separator />

            <DemoLoginButtons mode="support" tenant={tenant} />
          </CardContent>
        </Card>
